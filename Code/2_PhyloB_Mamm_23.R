#=============================================================#
# Calculate phylobetadiversity for mammals, cell groups 2 & 3 #
#=============================================================#
...
saveRDS(mamm_pb, "Data/mamm_pb_23.rds")
...
write.table(as.matrix(mamm_pb$phylo.beta.sim),
            file="Data/mamm_pb_sim_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(mamm_pb$phylo.beta.sor),
#            file="Data/mamm_pb_sor_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(mamm_pb$phylo.beta.sne),
#            file="Data/mamm_pb_sne_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with mamm_23")
