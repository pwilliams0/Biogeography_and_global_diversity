...
# ---------- Map differences in residuals (Supplementary Fig. 2e) ----------
...
# Save figure
svg("Results/diffres_mamm_SR_realm.svg",
...
# ---------- Map differences in residuals (Supplementary Fig. 2f) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_mamm_PD_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
...
# ---------- Map differences in residuals (Supplementary Fig. 2g) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_mamm_FR_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
...
# ---------- Map differences in residuals (Supplementary Fig. 2h) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_mamm_FB_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
