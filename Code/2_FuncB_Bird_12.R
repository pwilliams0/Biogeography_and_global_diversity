#==================================================================#
# Calculate functional beta diversity for birds, cell groups 1 & 2 #
#==================================================================#
...
cell_list <- sort(c(group_1, group_2))
...
print("Done calculating functional beta diversity 12")
print(time_diff)

saveRDS(bird_fb, "Data/bird_fb_12.RDS")
#write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_diss),
#            file="Data/bird_fb_sor_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_turn),
            file="Data/bird_fb_turn_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_nest),
#            file="Data/bird_fb_nest_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_12")
