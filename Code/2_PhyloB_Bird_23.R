#===========================================================#
# Calculate phylobetadiversity for birds, cell groups 2 & 3 #
#===========================================================#
...
saveRDS(bird_pb, "Data/bird_pb_23.rds")
...
write.table(as.matrix(bird_pb$phylo.beta.sim),
            file="Data/bird_pb_sim_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sor),
#            file="Data/bird_pb_sor_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sne),
#            file="Data/bird_pb_sne_23.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_23")

# [Runtime 11 hr 40 min]
# [253 GB memory used]
