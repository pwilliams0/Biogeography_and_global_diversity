...
# ---------- Map differences in residuals (Supplementary Fig. 2a) ----------
...
# Save figure
svg("Results/diffres_bird_SR_realm.svg",
...
# ---------- Map differences in residuals (Supplementary Fig. 2b) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_bird_PD_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
...
# ---------- Map differences in residuals (Supplementary Fig. 2c) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_bird_FR_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
...
# ---------- Map differences in residuals (Supplementary Fig. 2d) ----------
...
res_map <- cells %>% right_join(res_df, by="cell_id")
# Save figure
svg("Results/diffres_bird_FB_realm.svg",
    width = 2.5, height = 1.5)
ggplot() +
  geom_sf(data = world, colour="grey85", lwd=.1, linewidth=.1) +
  geom_sf(data = res_map, aes(color = res, fill = res),
