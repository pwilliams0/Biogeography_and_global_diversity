#===========================================================#
# Calculate phylobetadiversity for birds, cell groups 2 & 4 #
#===========================================================#
...
saveRDS(bird_pb, "Data/bird_pb_24.rds")
...
write.table(as.matrix(bird_pb$phylo.beta.sim),
            file="Data/bird_pb_sim_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sor),
#            file="Data/bird_pb_sor_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sne),
#            file="Data/bird_pb_sne_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_24")

# [Runtime 11 hr 49 min]
# [253 GB memory used]
