#===========================================================#
# Calculate phylobetadiversity for birds, cell groups 1 & 2 #
#===========================================================#
...
saveRDS(bird_pb, "Data/bird_pb_12.rds")
...
write.table(as.matrix(bird_pb$phylo.beta.sim),
            file="Data/bird_pb_sim_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sor),
#            file="Data/bird_pb_sor_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sne),
#            file="Data/bird_pb_sne_12.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_12")

# [Runtime 10 hr 57 min]
# [247 GB memory used]
