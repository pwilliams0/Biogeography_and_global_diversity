#===========================================================#
# Calculate phylobetadiversity for birds, cell groups 3 & 4 #
#===========================================================#
...
saveRDS(bird_pb, "Data/bird_pb_34.rds")
...
write.table(as.matrix(bird_pb$phylo.beta.sim),
            file="Data/bird_pb_sim_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sor),
#            file="Data/bird_pb_sor_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sne),
#            file="Data/bird_pb_sne_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
