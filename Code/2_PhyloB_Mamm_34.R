#=============================================================#
# Calculate phylobetadiversity for mammals, cell groups 3 & 4 #
#=============================================================#
...
saveRDS(mamm_pb, "Data/mamm_pb_34.rds")
...
write.table(as.matrix(mamm_pb$phylo.beta.sim),
            file="Data/mamm_pb_sim_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(mamm_pb$phylo.beta.sor),
#            file="Data/mamm_pb_sor_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(mamm_pb$phylo.beta.sne),
#            file="Data/mamm_pb_sne_34.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with mamm_34")
