#==================================================================#
# Calculate functional beta diversity for birds, cell groups 2 & 4 #
#==================================================================#
...
cell_list <- sort(c(group_2, group_4))
...
print("Done calculating functional beta diversity 24")
print(time_diff)

saveRDS(bird_fb, "Data/bird_fb_24.RDS")
#write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_diss),
#            file="Data/bird_fb_sor_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_turn),
            file="Data/bird_fb_turn_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_fb$pairasb_fbd_indices$sor_nest),
#            file="Data/bird_fb_nest_24.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_24")
