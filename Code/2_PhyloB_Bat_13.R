#==========================================================#
# Calculate phylobetadiversity for bats, cell groups 1 & 3 #
#==========================================================#
...
saveRDS(bat_pb, "Data/bat_pb_13.rds")
...
write.table(as.matrix(bat_pb$phylo.beta.sim),
            file="Data/bat_pb_sim_13.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bat_pb$phylo.beta.sor),
#            file="Data/bat_pb_sor_13.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bat_pb$phylo.beta.sne),
#            file="Data/bat_pb_sne_13.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bat_13")
