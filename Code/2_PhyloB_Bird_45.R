#===========================================================#
# Calculate phylobetadiversity for birds, cell groups 4 & 5 #
#===========================================================#
...
saveRDS(bird_pb, "Data/bird_pb_45.rds")
...
write.table(as.matrix(bird_pb$phylo.beta.sim),
            file="Data/bird_pb_sim_45.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sor),
#            file="Data/bird_pb_sor_45.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)
#write.table(as.matrix(bird_pb$phylo.beta.sne),
#            file="Data/bird_pb_sne_45.txt", col.names=TRUE, row.name=TRUE, sep="\t", quote=FALSE)

print("Done with bird_45")
